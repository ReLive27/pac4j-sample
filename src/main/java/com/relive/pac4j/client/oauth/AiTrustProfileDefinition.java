 ...
 */
@Deprecated
public class AiTrustProfileDefinition extends OAuth20ProfileDefinition<AiTrustProfile, OAuth20Configuration> {
    public static final String USERNAME = "userName";
    public static final String ACCOUNT_NUMBER = "accountNumber";
    public static final String MAIL = "mail";
    public static final String PHONE_NUMBER = "phoneNumber";

    public AiTrustProfileDefinition() {
        super((x) -> {
            return new AiTrustProfile();
        });
    ...
    public String getProfileUrl(OAuth2AccessToken oAuth2AccessToken, OAuth20Configuration oAuth20Configuration) {
        return "https://aitrust.dbappsecurity.com.cn/iam/oauth2/common/otUserInfo";
    }

    @Override
    public AiTrustProfile extractUserProfile(String body) {
        AiTrustProfile profile = this.newProfile(new Object[0]);
        //此处取body中用户信息
